...
<div
	...
	class="flex {fullWidth
		...
		: 'w-fit'} items-center gap-3 rounded-xl border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-700 transition-colors dark:border-neutral-700/60 dark:bg-neutral-800/50 dark:text-neutral-200 {disabled
