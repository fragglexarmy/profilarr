	...
	>
		<div class="flex items-center justify-between gap-4">
				...
				{:else}
					...
					<div>
						<div class="text-sm font-medium text-neutral-900 dark:text-neutral-100">
							Next run in <span class="font-mono text-blue-600 dark:text-blue-400"
								>{formatTimeRemaining(timeUntilNext ?? 0)}</span
							>
						</div>
						<div class="text-xs text-neutral-500 dark:text-neutral-400">
			...
			<div class="text-right">
				<div
					class="flex items-center justify-end gap-1.5 text-xs text-neutral-500 dark:text-neutral-400"
				>
					<Clock size={12} />
					Last run
				</div>
